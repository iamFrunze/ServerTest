  ...
  const auth = new AppleAuth(
    {
      ...
      redirect_uri:
        "https://appleidanvost.netlify.app/callbacks/sign_in_with_apple", // does not matter here, as this is already the callback that verifies the token after the redirection
